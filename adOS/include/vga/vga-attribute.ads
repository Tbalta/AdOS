...
package VGA.Attribute is
   ...
   ------------------------
   type Attribute_Register is range 0 .. 2**6-1;
   for Attribute_Register'Size use 8;
   subtype Internal_Palette_Register_Index is Attribute_Register range 0 .. 2**5 - 1;
   ...
   --  function  Read_Internal_Palette_Register return Internal_Palette_Register;
...
private
   ...
   Attribute_Mode_Control : constant Attribute_Register := 16#10#;
   Overscan_Color         : constant Attribute_Register := 16#11#;
   Color_Plane_Enable     : constant Attribute_Register := 16#12#;
   Horizontal_PEL_Panning : constant Attribute_Register := 16#13#;
   Color_Select           : constant Attribute_Register := 16#14#;

   
   procedure Write_Address is new x86.Port_IO.Write_Port_8 (Address_Register_Address, Attribute_Register);

   generic
      type Data_Type is private;
      Index : Attribute_Register;
