...
package VGA.CRTC.Registers is
   ...
   with Size => 8;
   for End_Horizontal_Blanking_Register use
     record
   ...
   with Size => 8;
   for Preset_Row_Scan_Register use
     record
   ...
   with Size => 8;
   for Vertical_Retrace_End_Register use
     record
       VRE at 0 range 0 .. 3;
   ...
   with Size => 8;
   for Underline_Location_Register use
     record
   ...
   with Size => 8;
   for CRT_Mode_Control_Register use
     record
   ...
   procedure Write_Address is new
     x86.Port_IO.Write_Port_8 (Address_Register_Address, CRTC_Registers);
