...
package VGA.Graphic_Controller is
   ...
   type Color_Compare_Register is record
      ...
      with Size => 8;
   for Color_Compare_Register use record
      CC0 at 0 range 0 .. 0; 
      CC1 at 0 range 1 .. 1; 
      CC2 at 0 range 2 .. 2; 
      CC3 at 0 range 3 .. 3; 
   ...
   type Data_Rotate_Register is record
      ...
      with Size => 8;
   for Data_Rotate_Register use record
   ...
   type Miscellaneous_Register is
      record
         ...
         with Size => 8;
   for Miscellaneous_Register use record
   ...
   type Color_Dont_Care_Register is record
      ...
      with Size => 8;
   for Color_Dont_Care_Register use record
      M0X at 0 range 0 .. 0; 
      M1X at 0 range 1 .. 1; 
      M2X at 0 range 2 .. 2; 
      M3X at 0 range 3 .. 3; 
...
private
   ...
   procedure Write_Address is new x86.Port_IO.Write_Port_8 (Address_Register_Address, Graphic_Controller_Register);
