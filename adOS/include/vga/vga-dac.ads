...
private
   ...
   type DAC_Register is (DAC_State, Palette_Data, PEL_Mask);

   function Read_Dac_State_Register is new
     x86.Port_IO.Read_Port_8 (DAC_State_Register_Address, Unsigned_8);
   function Read_PEL_Mask_Register is new
     x86.Port_IO.Read_Port_8 (PEL_Mask_Register_Address, Unsigned_8);
   procedure Write_Palette_Data_Register is new
     x86.Port_IO.Write_Port_8 (Palette_Data_Register_Address, Color);
   procedure Write_Address is new
     x86.Port_IO.Write_Port_8 (Palette_Address_Register_Write_Address, Unsigned_8);
