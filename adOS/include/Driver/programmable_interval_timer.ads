...
private
   ...
   for Read_Write_Format use
     (Counter_Latch_Command => 2#00#, LSB_Only => 2#01#, MSB_Only => 2#10#, LSB_Then_MSB => 2#11#);

   type Mode_Format is
     (Interrupt_On_Terminal_Count,
      hardware_re_triggerable_one_shot,
      rate_generator,
   ...
   procedure Write_Control_Word is new
     Write_Port_8 (Control_Word_Register_Address, Control_Word_Format);
