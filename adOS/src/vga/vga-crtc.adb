...
package body VGA.CRTC is
   ...
   is
      procedure Write is new Write_Register (Horizontal_Display_Enable_End_Register, Horizontal_Display_Enable_End);
   begin
      Write (Register);
   ...
   is 
      function Read is new Read_Register (Horizontal_Display_Enable_End_Register, Horizontal_Display_Enable_End);
   begin
      return Read;
   ...
   is
      procedure Write is new Write_Register (End_Horizontal_Blanking_Register, End_Horizontal_Blanking);
   begin
      Write (Register);
   ...
   is 
      function Read is new Read_Register (End_Horizontal_Blanking_Register, End_Horizontal_Blanking);
   begin
      return Read;
   ...
   is
      procedure Write is new Write_Register (Start_Horizontal_Retrace_Pulse_Register, Start_Horizontal_Retrace_Pulse);
   begin
      Write (Register);
   ...
   is 
      function Read is new Read_Register (Start_Horizontal_Retrace_Pulse_Register, Start_Horizontal_Retrace_Pulse);
   begin
      return Read;
   ...
   is
      procedure Write is new Write_Register (End_Horizontal_Retrace_Register, End_Horizontal_Retrace);
   begin
      Write (Register);
   ...
   is
      procedure Write is new Write_Register (Vertical_Retrace_Start_Register, Vertical_Retrace_Start);
   begin
      Write (Register);
   ...
   is
      procedure Write is new Write_Register (Vertical_Display_Enable_End_Register, Vertical_Display_Enable_End);
   begin
      Write (Register);
   ...
   is 
      function Read is new Read_Register (Vertical_Display_Enable_End_Register, Vertical_Display_Enable_End);
   begin
      return Read;
   ...
   is
      procedure Write is new Write_Register (Start_Vertical_Blanking_Register, Start_Vertical_Blanking);
   begin
      Write (Register);
   ...
   is 
      function Read is new Read_Register (Start_Vertical_Blanking_Register, Start_Vertical_Blanking);
   begin
      return Read;
