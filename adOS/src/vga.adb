...
package body VGA is
   ...
   function Get_MSL_Multiplier (Height : Scan_Line_Count) return Integer
   is
   ...
   is
      ...
      Configuration : VGA_Configuration := Get_Configuration (Width * Dot_Per_Pixel, Height * Scan_Per_Character_Row);
   ...
   begin
      ...
      Write_Horizontal_Display_Enable_End_Register (Horizontal_Display_Enable_End_Register (Configuration.Active_H_Chars - 1));
      ...
      Write_Maximum_Scan_Line_Register ((MSL           => Unsigned_5 (Scan_Per_Character_Row) - 1,
                                       Double_Scanning => False,
                                       others => 0));
