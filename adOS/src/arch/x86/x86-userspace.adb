...
package body x86.Userspace is
   ...
   procedure Jump_To_Userspace
      (Entry_Point : Virtual_Address;
       CR3         : x86.vmm.CR3_register) is
      
      New_Stack : constant Virtual_Address := x86.vmm.kmalloc (CR3, 4096);
   begin
      SERIAL.send_line
        ("Jumping to userspace at " & Entry_Point'Image &
         " with stack at " & New_Stack'Image);
      ...
      SERIAL.send_line
        ("Jumped to userspace at " & Entry_Point'Image &
         " with stack at " & New_Stack'Image);
