...
package body x86.gdt is
   ...
   begin
      ...
      set_gdt_entry (1, base_address, limit, 16#9A#, 16#C#); -- Kernel Code descriptor
      set_gdt_entry (2, base_address, limit, 16#92#, 16#C#); -- Kernel Data descriptor
      set_gdt_entry (3, base_address, limit, 16#FA#, 16#C#); -- User Code descriptor
